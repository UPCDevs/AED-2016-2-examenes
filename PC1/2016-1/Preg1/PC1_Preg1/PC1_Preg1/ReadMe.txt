========================================================================
    APLICACIÓN: PC1_Preg1 Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PC1_Preg1.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación PC1_Preg1.
